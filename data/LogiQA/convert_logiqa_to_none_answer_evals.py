...
with open("/data/qbao775/Logical-and-abstract-reasoning/data/LogiQA/Test_none_answer_evals.jsonl", "w", encoding="utf-8") as output_file:
    for item in data:
        ...
        if option_list[0] == item["answers"][item["label"]]:
            ...
            label = "D"
        option_list[item["label"]] = "None of the other options are correct."
