...
# read JSON file
with open("/data/qbao775/Logical-and-abstract-reasoning/data/ReClor/train.json", "r", encoding="utf-8") as input_file:
    data = json.load(input_file)

# save to a new JSONL file
with open("/data/qbao775/Logical-and-abstract-reasoning/data/ReClor/train_shuffle_options_evals.jsonl", "w", encoding="utf-8") as output_file:
    for item in data:
