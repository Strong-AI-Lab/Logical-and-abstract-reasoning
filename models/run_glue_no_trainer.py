...
task_to_keys = {
    ...
    "qbao775/PARARULE-Plus-Depth-2": ("context", "question"),
    "qbao775/PARARULE-Plus-Depth-3": ("context", "question"),
    "qbao775/PARARULE-Plus-Depth-4": ("context", "question"),
    "qbao775/PARARULE-Plus-Depth-5": ("context", "question"),
    "qbao775/PARARULE-Plus": ("context", "question"),
}
...
def main():
    ...
    if args.task_name is not None:
        if args.task_name in ['cola', 'sst2', 'mrpc', 'qqp', 'stsb', 'mnli', 'mnli_mismatched', 'mnli_matched', 'qnli', 'rte', 'wnli', 'ax']:
    ...
    if args.task_name is not None and args.task_name in ["sst2", "mnli", "mnli_mismatched", "mnli_matched", "cola", "stsb", "mrpc", "qqp", "qnli", "rte", "wnli", "hans"]:
